...
#ifndef ETFuncDefine_h
#define ETFuncDefine_h


typedef void(^ETNoParamNoReturnBlock)(void);

typedef void(^ETIndexAndValueNoReturnBlock)(NSUInteger index, id value);

typedef void(^ETSelectButtonBlock)(UIButton *button);  
...
// 本地化
#define ETSTRING(_str)  NSLocalizedString((_str),(_str))

#endif /* ETFuncDefine_h */
